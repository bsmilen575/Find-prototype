    ...
    <div className="w-full h-full flex flex-col" style={{ backgroundColor: '#f5f3f0', fontFamily: 'Georgia, Garamond, serif' }} data-testid="onboarding-screen">
      <div className="flex-1 flex flex-col items-center justify-center px-8 pt-16 pb-8">
        <div className="relative w-48 h-48 mb-12" data-testid="sphere-container">
          {/* Hyper-realistic Metallic Silver Sphere */}
          <div 
          ...
          {/* Secondary metallic reflection band */}
          <div 
            className="absolute rounded-full"
            style={{
              top: '35%',
          ...
          {/* Bottom environmental reflection */}
          <div 
            className="absolute rounded-full"
            style={{
              bottom: '18%',
          ...
          {/* Additional metallic sheen streaks */}
          <div 
            className="absolute rounded-full"
            style={{
              top: '55%',
          ...
          {/* Neural Network Overlay - Web-like structure */}
