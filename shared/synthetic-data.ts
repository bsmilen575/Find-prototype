...
export const syntheticUserGraph: UserGraph = {
  ...
  nodes: [
    ...
    { id: 'n8', label: 'TV Recommendations', type: 'topic', attentionWeight: 76, source: 'Twitter + Reddit', evidence: { saves: 29, visits: 52 }, firstSeen: '2024-07-15', lastActive: '2025-01-04', cluster: 'c2', createdAt: '2024-07-15', activityScore: 'High', sharedCount: 16, trending: false },
    ...
    { id: 'n11', label: 'Travel Destinations', type: 'topic', attentionWeight: 90, source: 'Instagram + Google', evidence: { saves: 142, visits: 67 }, firstSeen: '2024-06-01', lastActive: '2025-01-07', cluster: 'c3', createdAt: '2024-06-01', activityScore: 'High', sharedCount: 24, trending: true },
    ...
    { id: 'n19', label: 'Interior Design', type: 'topic', attentionWeight: 88, source: 'Instagram + Pinterest', evidence: { saves: 267, likes: 345 }, firstSeen: '2024-03-10', lastActive: '2025-01-08', cluster: 'c5', createdAt: '2024-03-10', activityScore: 'High', sharedCount: 25, trending: true },
    ...
    { id: 'n23', label: 'Indie Music', type: 'topic', attentionWeight: 91, source: 'Spotify + Instagram', evidence: { likes: 456, visits: 234 }, firstSeen: '2024-02-01', lastActive: '2025-01-08', cluster: 'c6', createdAt: '2024-02-01', activityScore: 'High', sharedCount: 22, trending: true },
    ...
    { id: 'n30', label: 'Tech News', type: 'topic', attentionWeight: 81, source: 'Twitter + Reddit', evidence: { visits: 189, likes: 67 }, firstSeen: '2024-01-01', lastActive: '2025-01-08', cluster: 'c8', createdAt: '2024-01-01', activityScore: 'High', sharedCount: 21, trending: true },
